...
input int InpSessionTimeZonesHour = 3; // Timezone (Hour)
...
input int InpSession1StartHour = 02; // Session 1 Time (Start Hour)
input int InpSession1StartMin = 30; // Session 1 Time (Start Min)
input int InpSession1EndHour = 05; // Session 1 Time (End Hour)
...
input int InpSession2StartHour = 09; // Session 2 Time (Start Hour)
input int InpSession2StartMin = 30; // Session 2 Time (Start Min)
input int InpSession2EndHour = 12; // Session 2 Time (End Hour)
...
input int InpSession3StartHour = 15; // Session 3 Time (Start Hour)
input int InpSession3StartMin = 00; // Session 3 Time (Start Min)
input int InpSession3EndHour = 17; // Session 3 Time (End Hour)
